...
function setMode(bStatus){
	...
	if(bStatus){
		...
		if(gIsIE){
			HtmlEditor.style.height = "386px";
			divEditor.style.height = "386px";
		}else{
			HtmlEditor.style.height = "385px";
			divEditor.style.height = "385px";
		}
...
function createLink() {
	var sURL=window.prompt("Enter link location (e.g. http://):", "http://");
