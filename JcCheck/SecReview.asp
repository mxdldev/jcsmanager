...
Sub ShowArt(id)
  ...
  Sql="select Title,PaperId,PublishDate,Content,ArticleChecks From Tb_Article Where ArticleId="&id
...
Response.Write "</tr>"&vbcrlf  
Response.Write "<tr>"&vbcrlf
Response.Write "<td align=""right"">内容：</td>"&vbcrlf
Response.Write "<td class=""category1"">"&Ds(3,0)&"</td>"&vbcrlf
Response.Write "</tr>"&vbcrlf 
Response.Write "<tr>"&vbcrlf
Sql1="select ReportContent From Check_Report Where ReportClass=1 And ArticleID="&id
...
Response.Write "<td class=""category1""> 通过：<input type=""radio"" name=""artcheck"" value=3 style=""border:none"""
If Ds(4,0)=3 Then Response.Write "checked"
Response.Write ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;不通过<input type=""radio"" name=""artcheck"" value=4 style=""border:none"""
If Ds(4,0)=4 Then Response.Write "checked"
Response.Write "></td>"&vbcrlf
Response.Write "</tr>"&vbcrlf 
Response.Write "<tr>"&vbcrlf
...
Sub AddReview()
  ...
  Else
	...
	If Not Rs.eof Then
	 Ds=Rs.GetRows()
	 Sql="Update Check_Report Set ArticleID="&id&",ReportContent='"&Content&"',ReportClass=1,UserID="&Jcs.UserId&" Where RId="&Ds(0,0)
	 Jcs.WriteLog Jcs_Check.GetArticleTitle(id),"修改文章审核意见"
	 Else
    Sql="insert into Check_Report (ArticleID,ReportContent,ReportClass,UserID) values("&id&",'"&Content&"',1,"&Jcs.UserId&")"
	Jcs.WriteLog Jcs_Check.GetArticleTitle(id),"添加文章审核意见"
	End If
	'response.Write sql
	'response.end
	...
	Jcs.Execute(Sql)
	Msg="审核意见添加成功！"
      Sql="Update Tb_Article Set ArticleChecks="&artcheck&" Where ArticleId="&id
	  Jcs.Execute(Sql)
	Jcs.BackInfo "SecArtList.asp?PaperId="&PaperId&"",2
  End If
End Sub
