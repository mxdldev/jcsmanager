document.write('<iframe id=CalFrame name=CalFrame frameborder=0 src=../skin/Js/calendar1.htm style=display:none;position:absolute;z-index:100></iframe>');
...
function showCalendar(sImg,bOpenBound,sFld1,sFld2,sCallback,type)
{
	...
	if(fld1.tagName!="INPUT"||fld1.type!="hidden"){alert("输入控件类型错误！");return;}
	if(sFld2)
	{
