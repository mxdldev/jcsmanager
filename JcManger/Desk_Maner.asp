...
Jcs.CheckManger()
Dim countpaper
countpaper = Jcs_Manger.CountPaper()
 %>
<HTML><HEAD><TITLE>管理员系统桌面</TITLE>
    ...
    <TBODY>
        ...
        <TR>
            <TD style="background-image: url('/skin/images/windty_bg.jpg'); padding-right: 1px; padding-bottom: 1px" colSpan=3 height=90>
                <DIV style="BORDER-RIGHT: #b9c9ef 1px solid; PADDING-RIGHT: 13px; BORDER-TOP: #728eb8 1px solid; PADDING-LEFT: 13px; FONT-SIZE: 12px; PADDING-BOTTOM: 13px; BORDER-LEFT: #728eb8 1px solid; WIDTH: 100%; COLOR: #1f336b; PADDING-TOP: 18px; BORDER-BOTTOM: #b9c9ef 1px solid; HEIGHT: 100%">新入库报纸<%=countpaper%>期，尚未分配任务，现在分配任务吗？<BR>
                <DIV align=center style="word-break:break-all"><a href="Give_TaskPaper.Asp" target="right">
...
if (<%=countpaper%>>0)
{document.getElementById('eMeng').style.display = "";
}
</script>
<!--温馨提示代码结束-->
